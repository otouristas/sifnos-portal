...
export const getHomepageSEO = (): SEOData => ({
  ...
  image: "https://travelsifnos.com/touristas-ai-logo.svg"
});
...
export const getBusinessSEO = (business: any): SEOData => {
  ...
  return {
    ...
    image: business.photo_urls?.[0] || "https://travelsifnos.com/touristas-ai-logo.svg"
  };
};
...
export const getBeachSEO = (beach: any): SEOData => {
  ...
  return {
    ...
    image: beach.photos?.[0] || "https://travelsifnos.com/touristas-ai-logo.svg"
  };
};
